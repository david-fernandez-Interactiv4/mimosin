...
class Mage_Core_Model_Config_Options extends Varien_Object
{
    ...
    public function getDir($type)
    {
        ...
        $dir = $this->$method();
        if (!$dir) {
            throw Mage::exception('Mage_Core', 'Invalid screen.scss type requested: '.$type);
        }
        return $dir;
    }
    ...
    {
        //$screen.scss = $this->getDataSetDefault('var_dir', $this->getBaseDir().DS.'var');
    ...
    {
        //$screen.scss = $this->getDataSetDefault('tmp_dir', $this->getVarDir().DS.'tmp');
    ...
    {
        //$screen.scss = $this->getDataSetDefault('cache_dir', $this->getVarDir().DS.'cache');
    ...
    {
        //$screen.scss = $this->getDataSetDefault('log_dir', $this->getVarDir().DS.'log');
    ...
    {
        //$screen.scss = $this->getDataSetDefault('session_dir', $this->getVarDir().DS.'session');
    ...
    {
        //$screen.scss = $this->getDataSetDefault('upload_dir', $this->getMediaDir().DS.'upload');
    ...
    {
        //$screen.scss = $this->getDataSetDefault('export_dir', $this->getVarDir().DS.'export');
